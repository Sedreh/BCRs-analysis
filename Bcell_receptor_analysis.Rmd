...
```{r}
#load the dataset
filtered_data = read.csv ('/home/sedreh/ITMO/semester2/Bcellsproject/final_Rcode/GM12878_human/vdj_v1_hs_gm12878_b_filtered_contig_annotations.csv')
```
...
```{r}
#load the dataset
data_migmap <-read.csv ('/home/sedreh/ITMO/semester2/Bcellsproject/final_Rcode/GM12878_human/migmap_GM12878_human.csv', sep="\t", header=TRUE)
```
...
migmap <-read.csv ('/home/sedreh/ITMO/semester2/Bcellsproject/final_Rcode/GM12878_human/migmap_GM12878_human.csv', sep="\t", header=TRUE)
#load fasta file for recognizing light chains in cells
d <- read.fasta('/home/sedreh/ITMO/semester2/Bcellsproject/final_Rcode/GM12878_human/vdj_v1_hs_gm12878_b_filtered_contig.fasta')
